      ...
      {sham === false ? (
        ...
        <div className="dh1  " style={{ height: hl }}>
          <div className="hw1 position-absolute top-0 mt-3 ">
            ...
            {temp ? (
              <div className="mt-5 container d-flex flex-column gap-2">
                <div className="mt-3">
                  {" "}
                  <a onClick={tfal} href="#bg">
                    Home
                  </a>
                </div>
                <div className="my-1">
                  {" "}
                  <a onClick={tfal} href="#projects">
                    Projects
                  </a>
                </div>
                <div className="my-1">
                  {" "}
                  <a onClick={tfal} href="#skills">
                    Skills
                  </a>
                </div>
                <div className="my-1">
                  {" "}
                  <a onClick={tfal} href="#hobbies">
                    Hobbies
                  </a>
                </div>
                <div className="my-1">
                  {" "}
                  <a onClick={tfal} href="#home">
                    About Me
                  </a>{" "}
                </div>
              </div>
