      ...
      {sham == false ? (
        ...
        // } */}
          ...
          {temp ? <div className="container d-flex flex-column justify-content-center">
            <div className=""  > <a onClick={tfal}  href="#bg">Home</a></div>
            <div className=""  > <a onClick={tfal} href="#projects">Projects</a></div>
            <div className="" > <a onClick={tfal} href="#skills">Skills</a></div>
            <div className="" > <a onClick={tfal} href="#hobbies">Hobbies</a></div>
            <div className="" > <a onClick={tfal} href="#home">About Me</a>{" "}</div>
          </div> : <></>}
        </div>
        </div>
