  ...
  return (
    <div className="pt-12 bg-white" id="home">
      ...
      <h1 className="tc  mt-2 mb-4  text-light">About Me</h1>
        ...
        <div className="dh2  ">
          <div className=" card text-center rounded-5 m-2" style={{ width: "100%" }}>
            ...
            <a href="https://drive.google.com/file/d/1iuMTP7Wd7EBrqT2awbY8gt4BAVetrD-6/view" rel="external" target="_blank" className=" btn btn-sm bsm  m-3 me-5 btn-dark ">Resume <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class=" mb-1 bi bi-link" viewBox="0 0 16 16">
