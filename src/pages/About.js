        ...
        <div className="dh2  ">
          ...
          >
            <div className="card-body text-start p5">
              ...
              <span className="fs-6 fw-medium">CGPA : 9.22 / 10</span>
              <p className="mt-2 card-text par">
                I am in Final Year pursuing B.E. (Computer Engineering)
                Learning from Pune Institute of Computer Technology, Pune. My
                main interests are Problem Solving, Web Development. I am
            ...
            <div className="d-flex justify-content-between ">
              <div
                ...
                style={{ width: "10vw" }}
              >
                <a href="https://www.linkedin.com/in/prath4912" target="_blank">
                  <svg
                ...
                <a href="https://github.com/prath4912" target="_blank">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="25"
                    height="25"
              ...
              <span>
                <a
                  href="https://drive.google.com/file/d/1W2JcYK0-wLAMBMzHxP8oEQjBw9as3otK/view?usp=sharing"
                  rel="external"
                  target="_blank"
